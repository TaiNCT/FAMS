...
import ButtonSubmit from "../../../TrainingCalendar/component/ButtonUtil";
...
import { fetchFilteredDataWeek } from "../../../ClassList/api/FilterApi";
import { FsuListApi, TrainingProgramListAPI, LocationList } from "../../../ClassList/api/ListApi";
import dayjs from "dayjs";
import { ClearAll } from "@mui/icons-material";

export default function FilterWeek({ fetchData, anchorEl, setAnchorEl, onFilteredData, setIsFiltered, setFilteredList, startOfWeek, endOfWeek }) 
{
    ...
    const handleFilterSubmit = async () =>
    {
        ...
        const data = await fetchFilteredDataWeek(checkedBoxStatus, selectedFSU, selectedProgram,
            checkedBoxAttendee, selectedLocationIds,
            slotTimes, selectedStartDate, selectedEndDate, formattedStartOfWeek, formattedEndOfWeek);
        setIsFiltered(true);
        onFilteredData(data);
        handleClose();
