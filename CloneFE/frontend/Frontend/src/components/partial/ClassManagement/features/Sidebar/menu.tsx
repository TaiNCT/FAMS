import NavigationIcons from "../Sidebar/components/icons/navigation-icons";
import { MenuItem } from "../Sidebar/types/menuItems";
import { useState } from "react";
import MenuButton from "../Sidebar/menu-components/menu-collapse-button";
import MenuItemGroup from "../Sidebar/menu-components/menu-item-group";
import { useAppDispatch, useAppSelector } from "./hooks/useRedux";
import { toggleSidebar } from "../Sidebar/lib/redux/sidebarSlice";
