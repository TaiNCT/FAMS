...
const SyllabusOutline = ({ syllabusDays, setSyllabusDays, syllabusDetailOutline, setsyllabusDetailOutline }:
  {
    syllabusDays: SyllabusDay[];
    setSyllabusDays: (syllabusDays: SyllabusDay[]) => void;
    syllabusDetailOutline: Array<SyllabusDetailOutline>;
    setsyllabusDetailOutline: (syllabusDetailOutline: Array<SyllabusDetailOutline>) => void;
  }) => {
        ...
        >
          <CardBody style={{ padding: 0 }}>
            <Accordion defaultIndex={[0]} allowMultiple>
              <Unit setsyllabusDetailOutline={setsyllabusDetailOutline} syllabusDays={syllabusDays} setSyllabusDays={setSyllabusDays} syllabusDetailOutline={syllabusDetailOutline} />
            </Accordion>
          </CardBody>
        </Card>
