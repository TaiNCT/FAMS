...
import AddNewRemindTab from "./AddNewRemindTab";
import FormFilter from "./FilterRemindTab";
import { EmailTable, EmailTemplate, TableParams } from "./RemindTabConfigTable";
