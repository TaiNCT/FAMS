...
END;
ALTER DATABASE [FAMS] SET COMPATIBILITY_LEVEL = 150
GO
IF (1 = FULLTEXTSERVICEPROPERTY('IsFullTextInstalled'))
begin
EXEC [FAMS].[dbo].[sp_fulltext_database] @action = 'enable'
end
GO
...
GO
ALTER DATABASE [FAMS] SET  DISABLE_BROKER
GO
...
GO
ALTER DATABASE [FAMS] SET RECOVERY SIMPLE
GO
...
GO
ALTER DATABASE [FAMS] SET ACCELERATED_DATABASE_RECOVERY = OFF
GO
ALTER DATABASE [FAMS] SET QUERY_STORE = OFF
GO
USE [FAMS]
GO
/****** Object:  Table [dbo].[__EFMigrationsHistory]    Script Date: 3/18/2024 1:26:50 PM ******/
SET ANSI_NULLS ON
GO
...
GO
/****** Object:  Table [dbo].[AssessmentScheme]    Script Date: 3/18/2024 1:26:50 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Assignment]    Script Date: 3/18/2024 1:26:50 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[AttendeeType]    Script Date: 3/18/2024 1:26:50 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
(
 ...
 CONSTRAINT [attendee_type_unique] UNIQUE NONCLUSTERED
(
...
GO
/****** Object:  Table [dbo].[Class]    Script Date: 3/18/2024 1:26:50 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[ClassUser]    Script Date: 3/18/2024 1:26:50 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[DeliveryType]    Script Date: 3/18/2024 1:26:50 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[EmailSend]    Script Date: 3/18/2024 1:26:50 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[EmailSendStudent]    Script Date: 3/18/2024 1:26:50 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[EmailTemplate]    Script Date: 3/18/2024 1:26:50 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
(
 ...
 CONSTRAINT [UQ__EmailTem__C443B510273F0DA5] UNIQUE NONCLUSTERED
(
	[emailTemplateId] ASC
)WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON, OPTIMIZE_FOR_SEQUENTIAL_KEY = OFF) ON [PRIMARY]
) ON [PRIMARY] TEXTIMAGE_ON [PRIMARY]
GO
/****** Object:  Table [dbo].[fsu]    Script Date: 3/18/2024 1:26:50 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Location]    Script Date: 3/18/2024 1:26:50 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Major]    Script Date: 3/18/2024 1:26:50 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
(
 ...
 CONSTRAINT [FK_MAJOR_NAME] UNIQUE NONCLUSTERED
(
	[name] ASC
)WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON, OPTIMIZE_FOR_SEQUENTIAL_KEY = OFF) ON [PRIMARY],
UNIQUE NONCLUSTERED
...
GO
/****** Object:  Table [dbo].[Module]    Script Date: 3/18/2024 1:26:50 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[OutputStandard]    Script Date: 3/18/2024 1:26:50 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Quiz]    Script Date: 3/18/2024 1:26:50 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[QuizStudent]    Script Date: 3/18/2024 1:26:50 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[ReservedClass]    Script Date: 3/18/2024 1:26:50 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Role]    Script Date: 3/18/2024 1:26:50 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
(
 ...
 CONSTRAINT [role_name_unique] UNIQUE NONCLUSTERED
(
	[RoleName] ASC
)WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON, OPTIMIZE_FOR_SEQUENTIAL_KEY = OFF) ON [PRIMARY],
UNIQUE NONCLUSTERED
...
GO
/****** Object:  Table [dbo].[RolePermission]    Script Date: 3/18/2024 1:26:50 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
(
 ...
 CONSTRAINT [UQ__RolePerm__8AFACE1B5732A972] UNIQUE NONCLUSTERED
(
	[RoleId] ASC
)WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON, OPTIMIZE_FOR_SEQUENTIAL_KEY = OFF) ON [PRIMARY]
) ON [PRIMARY]
GO
/****** Object:  Table [dbo].[Score]    Script Date: 3/18/2024 1:26:50 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Student]    Script Date: 3/18/2024 1:26:50 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
CREATE TABLE [dbo].[Student](
	...
	[CertificationStatus] [bit] NOT NULL DEFAULT 0,
	[Audit] [int] NOT NULL,
	[Mock] [float] NOT NULL,
...
(
 ...
 CONSTRAINT [UQ__Student__4D11D63DBF618A0B] UNIQUE NONCLUSTERED
(
	[studentId] ASC
)WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON, OPTIMIZE_FOR_SEQUENTIAL_KEY = OFF) ON [PRIMARY]
) ON [PRIMARY] TEXTIMAGE_ON [PRIMARY]
GO
/****** Object:  Table [dbo].[StudentClass]    Script Date: 3/18/2024 1:26:50 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
(
 ...
 CONSTRAINT [UQ__StudentC__114B9902500C79F3] UNIQUE NONCLUSTERED
(
	[studentClassId] ASC
)WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON, OPTIMIZE_FOR_SEQUENTIAL_KEY = OFF) ON [PRIMARY]
) ON [PRIMARY]
...
-- Creating triggers here
CREATE TRIGGER UpdateStudentStatusTrigger_____sqj1234
ON StudentClass
AFTER INSERT, UPDATE
AS
BEGIN
    ...
    IF EXISTS (
        SELECT 1
        FROM StudentClass
        WHERE AttendingStatus = 'In Class'
    )
    BEGIN
        UPDATE Student
        SET Status = 'active'
...
/****** Object:  Table [dbo].[StudentModule]    Script Date: 3/18/2024 1:26:50 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Syllabus]    Script Date: 3/18/2024 1:26:50 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
(
 ...
 CONSTRAINT [topic_code_unique] UNIQUE NONCLUSTERED
(
	[topic_code] ASC
)WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON, OPTIMIZE_FOR_SEQUENTIAL_KEY = OFF) ON [PRIMARY],
UNIQUE NONCLUSTERED
...
GO
/****** Object:  Table [dbo].[SyllabusDay]    Script Date: 3/18/2024 1:26:50 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[SyllabusUnit]    Script Date: 3/18/2024 1:26:50 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[TechnicalCode]    Script Date: 3/18/2024 1:26:50 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
(
 ...
 CONSTRAINT [technical_code_unique_name] UNIQUE NONCLUSTERED
(
...
GO
/****** Object:  Table [dbo].[TechnicalGroup]    Script Date: 3/18/2024 1:26:50 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
(
 ...
 CONSTRAINT [TechnicalGroupNameUnique] UNIQUE NONCLUSTERED
(
...
GO
/****** Object:  Table [dbo].[TrainingMaterial]    Script Date: 3/18/2024 1:26:50 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[TrainingProgram]    Script Date: 3/18/2024 1:26:50 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[TrainingProgramModule]    Script Date: 3/18/2024 1:26:50 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[TrainingProgramSyllabus]    Script Date: 3/18/2024 1:26:50 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[UnitChapter]    Script Date: 3/18/2024 1:26:50 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[User]    Script Date: 3/18/2024 1:26:50 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
(
 ...
 CONSTRAINT [UQ__User__CB9A1CFE05390903] UNIQUE NONCLUSTERED
(
	[userId] ASC
)WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON, OPTIMIZE_FOR_SEQUENTIAL_KEY = OFF) ON [PRIMARY],
 CONSTRAINT [UsernameUnique] UNIQUE NONCLUSTERED
(
	[Username] ASC
)WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON, OPTIMIZE_FOR_SEQUENTIAL_KEY = OFF) ON [PRIMARY]
) ON [PRIMARY] TEXTIMAGE_ON [PRIMARY]
GO
/****** Object:  Table [dbo].[UserPermission]    Script Date: 3/18/2024 1:26:50 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
ALTER TABLE [dbo].[EmailTemplate] ADD  CONSTRAINT [DF__EmailTemp__email__151B244E]  DEFAULT (CONVERT([nvarchar](36),newid())) FOR [emailTemplateId]
GO
ALTER TABLE [dbo].[EmailTemplate] ADD  CONSTRAINT [DF__EmailTemp__Creat__160F4887]  DEFAULT (getdate()) FOR [CreatedDate]
GO
ALTER TABLE [dbo].[EmailTemplate] ADD  CONSTRAINT [DF__EmailTemp__Updat__17036CC0]  DEFAULT (getdate()) FOR [UpdatedDate]
GO
...
GO
ALTER TABLE [dbo].[RolePermission] ADD  CONSTRAINT [DF_RolePermission_PermissionId]  DEFAULT (CONVERT([nvarchar](36),newid())) FOR [PermissionId]
GO
ALTER TABLE [dbo].[Score] ADD  DEFAULT (CONVERT([nvarchar](36),newid())) FOR [scoreId]
GO
ALTER TABLE [dbo].[Student] ADD  CONSTRAINT [DF__Student__student__245D67DE]  DEFAULT (CONVERT([nvarchar](36),newid())) FOR [studentId]
GO
ALTER TABLE [dbo].[StudentClass] ADD  CONSTRAINT [DF__StudentCl__stude__25518C17]  DEFAULT (CONVERT([nvarchar](36),newid())) FOR [studentClassId]
GO
...
GO
ALTER TABLE [dbo].[User] ADD  CONSTRAINT [DF__User__userId__2CF2ADDF]  DEFAULT (CONVERT([nvarchar](36),newid())) FOR [userId]
GO
...
GO
ALTER TABLE [dbo].[Student]  WITH CHECK ADD  CONSTRAINT [CK__Student__Gender__55F4C372] CHECK  (([Gender]='Other' OR [Gender]='Female' OR [Gender]='Male'))
GO
ALTER TABLE [dbo].[Student] CHECK CONSTRAINT [CK__Student__Gender__55F4C372]
GO
ALTER TABLE [dbo].[User]  WITH CHECK ADD  CONSTRAINT [CK__User__Gender__55F4C372] CHECK  (([Gender]='Other' OR [Gender]='Female' OR [Gender]='Male'))
GO
