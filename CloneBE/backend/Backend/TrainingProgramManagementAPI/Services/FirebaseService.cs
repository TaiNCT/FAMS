...
{
    // Task UploadItemAsync(Guid id, IFormFile file, string directoryPath);
    Task UploadItemAsync(IFormFile file, string directoryPath);
...
public class FirebaseService : IFirebaseService
{
    ...
    public async Task UploadItemAsync(IFormFile file, string directoryPath)
    {
    ...
    public async Task<bool> UpdateItemFileNameAsync(string directoryPath, string oldFileName, string newFileName, IFormFile? newFile)
    {
        ...
        if (prevObj != null)
        {
            ...
            else
            {
                ...
                await UploadItemAsync(customFile, directoryPath);
            }
