...
namespace ClassManagementAPI.Repositories
{
    public class ClassRepository : IClassRepository
    {
        ...
        public async Task AddUserToClassAsync(string userId, int classId)
        {
            var classObj = await _context.Classes.Include(c => c.ClassUsers).FirstOrDefaultAsync(c => c.Id == classId);
