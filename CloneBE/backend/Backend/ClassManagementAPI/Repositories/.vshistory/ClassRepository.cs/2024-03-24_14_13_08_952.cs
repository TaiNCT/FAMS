...
namespace ClassManagementAPI.Repositories
{
    public class ClassRepository : IClassRepository
    {
        ...
        public async Task UpdateClass(ViewInfoClassDetailDto classDto)
        {
            var existingClass = await _context.Classes.FindAsync(classDto.ClassId);
            ...
            existingClass.ClassStatus = classDto.ClassStatus;
            existingClass.ReviewBy = classDto.ReviewBy;
            existingClass.ReviewDate = classDto.ReviewDate;
            existingClass.ApprovedBy = classDto.ApprovedBy;
            existingClass.ApprovedDate = classDto.ApprovedDate;
            existingClass.CreatedBy = classDto.CreatedBy;
            existingClass.CreatedDate = classDto.CreatedDate;
            existingClass.AcceptedAttendee = classDto.AcceptedAttendee;
            existingClass.ActualAttendee = classDto.ActualAttendee;
            existingClass.PlannedAttendee = classDto.PlannedAttendee;
