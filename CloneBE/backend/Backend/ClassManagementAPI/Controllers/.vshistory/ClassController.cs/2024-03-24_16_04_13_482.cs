...
namespace ClassManagementAPI.Controllers
{
    ...
    public class ClassController : ControllerBase
    {
        ...
        [HttpPut("{classId}")]
        public async Task<IActionResult> UpdateClass(string classId, [FromBody] UpdatedClassDto classDto)
        {
            try
            {
                await _classRepository.UpdateClass(classDto, classId);
        ...
        public async Task<IActionResult> GetAdminUsers()
        {
            try
            {
                var adminUsers = await _userRepository.GetUsersByRoleName("Admin");
