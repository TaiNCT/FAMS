    ...
    public class ClassController : ControllerBase
    {
        ...
        public async Task<IActionResult> UpdateClass(string classId, UpdatedClassDto updatedClassDto)
        {
            try
            {
                ...
                existingClass.ClassStatus = updatedClassDto.ClassStatus;
                existingClass.Duration = updatedClassDto.Duration;
                existingClass.StartDate = updatedClassDto.StartDate;
                existingClass.EndDate = updatedClassDto.EndDate;
                // Update other properties as needed

                // Save changes
                await _classRepository.UpdateClass(existingClass);

                // Return updated class details
                var updatedClass = await _classRepository.GetClassById(classId);
