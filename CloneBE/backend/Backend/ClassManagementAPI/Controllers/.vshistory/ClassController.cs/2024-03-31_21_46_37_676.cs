    ...
    public class ClassController : ControllerBase
    {
        ...
        public async Task<IActionResult> UpdateClass(string classId, UpdatedClassDto updatedClassDto)
        {
            try
            {
                ...
                if (existingClass.Fsu != null)
                {
                    _classRepository.Entry(existingClass.Fsu).State = EntityState.Detached;
                }
               ...
               /* existingClass.TrainingProgramCodeNavigation = new TrainingProgram
                ...
                if (existingClass.TrainingProgramCodeNavigation != null)
                {
                    _classRepository.Entry(existingClass.TrainingProgramCodeNavigation).State = EntityState.Detached;
                }*/
