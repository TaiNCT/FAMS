...
namespace ClassManagementAPI.Controllers
{
    ...
    public class ClassController : ControllerBase
    {
        ...
        public IActionResult UpdateTrainingProgramCode(string classId, [FromBody] string trainingProgramCode)
        {
            try
            {
                var classEntity = _context.Classes.FirstOrDefault(c => c.ClassId == classId);
                ...
                var trainingProgramEntity = _context.TrainingPrograms.FirstOrDefault(tp => tp.TrainingProgramCode == trainingProgramCode);
                if (trainingProgramEntity == null)
                {
                    return NotFound(); // Training program not found
                }

                // Update TrainingProgramCode in the class
                classEntity.TrainingProgramCode = trainingProgramCode;
