...
public class UserUpdatedConsumer : IConsumer<UserUpdated>
{
    ...
    // Default constructor
    // Argument contructor
    public UserUpdatedConsumer(IMapper mapper, UserManager<ApplicationUser> userManager)
    {
        _mapper = mapper;
    ...
    public async Task Consume(ConsumeContext<UserUpdated> context)
    {
        try
        {
            ...
            identityEntity.RoleId = updateIdentityEntity.RoleId;
            ...
            if (result.Succeeded) Console.WriteLine("--> Consume update user successfully");
        }
