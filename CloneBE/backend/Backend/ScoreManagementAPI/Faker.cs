        ...
        public void fake(ModelBuilder modelBuilder)
        {
          ...
          /*  // Fake "Role" data
            ...
            modelBuilder.Entity<Student>().HasData(
                new Student { StudentId = "cd9fe541-1c6f-4e9e-a94b-1ff748186975",CertificationStatus = false, Id = 1, Area = "Ho Chi Minh", MajorId = "IT101", University = "Greenwich", Type = 11, Status = false, Address = JsonConvert.SerializeObject(new Dictionary<string, string> { { "permanent_res", "Vietnam, Ho Chi Minh city" }, { "location", "Ho Chi Minh city" } }), Phone = "111-232-1312", Dob = DateTime.Now, Email = "vinh@fpt.edu.vn", Faaccount = "DTVinh12223", FullName = "Đinh Thế Vinh", Gender = 1, Gpa = 88, GraduatedDate = DateTime.Now, JoinedDate = DateTime.Now, Recer = "Ho Hai Quang" },
                new Student { StudentId = "7a3e4b3c-5201-45fc-bb7d-18ab7e26cc50",CertificationStatus = false, Id = 2, Area = "Ho Chi Minh city", MajorId = "AS101", University = "FPT", Type = 23, Status = false, Address = JsonConvert.SerializeObject(new Dictionary<string, string> { { "permanent_res", "Vietnam, Ho Chi Minh city" }, { "location", "Ho Chi Minh city" } }), Phone = "111-111-123", Dob = DateTime.Now, Email = "v122@fpt.edu.vn", Faaccount = "HHSon2k1", FullName = "Hoàng Hải Sơn", Gender = 1, Gpa = 22, GraduatedDate = DateTime.Now, JoinedDate = DateTime.Now, Recer = "Tran Tat Nghia" },
                new Student { StudentId = "ea21b42d-89a2-4e9e-a6b6-d6a9c7b52480",CertificationStatus = false, Id = 3, Area = "Da Nang", MajorId = "TC101", University = "RMIT", Type = 41, Status = false, Address = JsonConvert.SerializeObject(new Dictionary<string, string> { { "permanent_res", "Vietnam, Ha Noi" }, { "location", "Ha Noi" } }), Phone = "111-111-33", Dob = DateTime.Now, Email = "add112@fpt.edu.vn", Faaccount = "DungNQ111", FullName = "Nguyễn Quang Dũng", Gender = 1, Gpa = 12, GraduatedDate = DateTime.Now, JoinedDate = DateTime.Now, Recer = "Nguyen Quang Dung" },
                new Student { StudentId = "3dc8f1f1-0a7a-4db4-91c3-98b93ec1b2a3",CertificationStatus = false, Id = 4, Area = "Da Nang", MajorId = "TC101", University = "Hutech", Type = 2, Status = true, Address = JsonConvert.SerializeObject(new Dictionary<string, string> { { "permanent_res", "United States" }, { "location", "New York" } }), Phone = "111-111-2411", Dob = DateTime.Now, Email = "camecam@fpt.edu.vn", Faaccount = "CarmOD1k9", FullName = "Carmila Odesn", Gender = 1, Gpa = 32, GraduatedDate = DateTime.Now, JoinedDate = DateTime.Now, Recer = "Ho Hai Quang" },
                new Student { StudentId = "97d39a95-2e4b-437f-a032-35e6357f06aa",CertificationStatus = false, Id = 5, Area = "Hue", MajorId = "AS101", University = "Tampere", Type = 22, Status = false, Address = JsonConvert.SerializeObject(new Dictionary<string, string> { { "permanent_res", "Finland" }, { "location", "Tampere" } }), Phone = "111-111-2411", Dob = DateTime.Now, Email = "hestamp@fpt.edu.vn", Faaccount = "HelT112", FullName = "Helsinji Tampe", Gender = 1, Gpa = 88, GraduatedDate = DateTime.Now, JoinedDate = DateTime.Now, Recer = "Tran Tat Nghia" },
                new Student { StudentId = "35f2f906-2a79-442e-b7d8-2f3f59c7c89c",CertificationStatus = false, Id = 6, Area = "Helsinki", MajorId = "AS101", University = "Helsinki", Type = 18, Status = true, Address = JsonConvert.SerializeObject(new Dictionary<string, string> { { "permanent_res", "Finland" }, { "location", "Helsinki" } }), Phone = "123-456-7890", Dob = DateTime.Parse("2000-05-15"), Email = "example1@example.com", Faaccount = "example1", FullName = "John Doe", Gender = 0, Gpa = 75, GraduatedDate = DateTime.Parse("2023-06-30"), JoinedDate = DateTime.Parse("2020-09-01"), Recer = "Alice Johnson" },
                new Student { StudentId = "d269b62c-c9dc-4d8f-8b3c-602d88e72438",CertificationStatus = false, Id = 7, Area = "Turku", MajorId = "ER101", University = "Turku", Type = 20, Status = false, Address = JsonConvert.SerializeObject(new Dictionary<string, string> { { "permanent_res", "Finland" }, { "location", "Turku" } }), Phone = "987-654-3210", Dob = DateTime.Parse("2001-08-20"), Email = "example2@example.com", Faaccount = "example2", FullName = "Jane Smith", Gender = 1, Gpa = 92, GraduatedDate = DateTime.Parse("2024-05-31"), JoinedDate = DateTime.Parse("2021-08-15"), Recer = "Bob Anderson" },
                new Student { StudentId = "f3f59356-625e-47e7-9b9e-d2a8e6f2c6c6",CertificationStatus = false, Id = 8, Area = "Oulu", MajorId = "AS101", University = "Oulu", Type = 21, Status = true, Address = JsonConvert.SerializeObject(new Dictionary<string, string> { { "permanent_res", "Finland" }, { "location", "Oulu" } }), Phone = "456-789-0123", Dob = DateTime.Parse("1999-02-10"), Email = "example3@example.com", Faaccount = "example3", FullName = "Emma Johnson", Gender = 0, Gpa = 85, GraduatedDate = DateTime.Parse("2022-12-31"), JoinedDate = DateTime.Parse("2019-09-01"), Recer = "David Williams" },
                new Student { StudentId = "d5d5c72c-6b4a-4299-bc57-29cb8120e118",CertificationStatus = false, Id = 9, Area = "Vaasa", MajorId = "ER101", University = "Vaasa", Type = 19, Status = false, Address = JsonConvert.SerializeObject(new Dictionary<string, string> { { "permanent_res", "Finland" }, { "location", "Vaasa" } }), Phone = "789-012-3456", Dob = DateTime.Parse("2002-11-25"), Email = "example4@example.com", Faaccount = "example4", FullName = "Michael Brown", Gender = 1, Gpa = 68, GraduatedDate = DateTime.Parse("2025-06-30"), JoinedDate = DateTime.Parse("2022-08-15"), Recer = "Emily Garcia" },
                new Student { StudentId = "e8011711-9367-404e-b0a1-3cfa0e54f015",CertificationStatus = false, Id = 10, Area = "Tampere", MajorId = "TC101", University = "Tampere", Type = 22, Status = false, Address = JsonConvert.SerializeObject(new Dictionary<string, string> { { "permanent_res", "Finland" }, { "location", "Tampere" } }), Phone = "111-111-2411", Dob = DateTime.Now, Email = "hestamp@fpt.edu.vn", Faaccount = "HelT112", FullName = "Helsinji Tampe", Gender = 1, Gpa = 88, GraduatedDate = DateTime.Now, JoinedDate = DateTime.Now, Recer = "Tran Tat Nghia" },
                new Student { StudentId = "a4f15d45-0b76-4c1b-97b5-6a6b27229aae",CertificationStatus = false, Id = 11, Area = "Espoo", MajorId = "AS101", University = "Espoo", Type = 23, Status = true, Address = JsonConvert.SerializeObject(new Dictionary<string, string> { { "permanent_res", "Finland" }, { "location", "Espoo" } }), Phone = "555-555-5555", Dob = DateTime.Parse("2003-04-17"), Email = "example6@example.com", Faaccount = "example6", FullName = "Olivia Miller", Gender = 0, Gpa = 81, GraduatedDate = DateTime.Parse("2026-06-30"), JoinedDate = DateTime.Parse("2023-09-01"), Recer = "Daniel Moore" },
                new Student { StudentId = "815dd6f4-2d41-4c6c-a032-5e78a1cf065b",CertificationStatus = false, Id = 12, Area = "Jyväskylä", MajorId = "TC101", University = "Jyväskylä", Type = 24, Status = false, Address = JsonConvert.SerializeObject(new Dictionary<string, string> { { "permanent_res", "Finland" }, { "location", "Jyväskylä" } }), Phone = "222-222-2222", Dob = DateTime.Parse("2004-07-05"), Email = "example7@example.com", Faaccount = "example7", FullName = "William Wilson", Gender = 1, Gpa = 95, GraduatedDate = DateTime.Parse("2027-05-31"), JoinedDate = DateTime.Parse("2024-08-15"), Recer = "Sophia Taylor" },
                new Student { StudentId = "573e5801-f47e-4a82-bcb5-90fc722e4d4f",CertificationStatus = false, Id = 13, Area = "Kuopio", MajorId = "IT101", University = "Kuopio", Type = 25, Status = true, Address = JsonConvert.SerializeObject(new Dictionary<string, string> { { "permanent_res", "Finland" }, { "location", "Kuopio" } }), Phone = "333-333-3333", Dob = DateTime.Parse("2005-10-12"), Email = "example8@example.com", Faaccount = "example8", FullName = "Liam Brown", Gender = 1, Gpa = 72, GraduatedDate = DateTime.Parse("2028-12-31"), JoinedDate = DateTime.Parse("2025-09-01"), Recer = "Mia Clark" },
                new Student { StudentId = "39ffcf76-0db7-4f95-b1ae-3f527c8fe5a7",CertificationStatus = false, Id = 14, Area = "Rovaniemi", MajorId = "IT101", University = "Rovaniemi", Type = 26, Status = false, Address = JsonConvert.SerializeObject(new Dictionary<string, string> { { "permanent_res", "Finland" }, { "location", "Rovaniemi" } }), Phone = "444-444-4444", Dob = DateTime.Parse("2006-01-30"), Email = "example9@example.com", Faaccount = "example9", FullName = "Noah Anderson", Gender = 1, Gpa = 88, GraduatedDate = DateTime.Parse("2029-06-30"), JoinedDate = DateTime.Parse("2026-08-15"), Recer = "Ethan Adams" },
                new Student { StudentId = "b739b16a-24eb-49bb-b57a-86f8c3c9c2fc", CertificationStatus = false, Id = 15, Area = "Lahti", MajorId = "TC101", University = "Lahti", Type = 27, Status = true, Address = JsonConvert.SerializeObject(new Dictionary<string, string> { { "permanent_res", "Finland" }, { "location", "Lahti" } }), Phone = "666-666-6666", Dob = DateTime.Parse("2007-12-20"), Email = "example10@example.com", Faaccount = "example10", FullName = "Sophia Wilson", Gender = 0, Gpa = 79, GraduatedDate = DateTime.Parse("2030-05-31"), JoinedDate = DateTime.Parse("2027-09-01"), Recer = "Logan Baker" }
                );
            ...
            modelBuilder.Entity<StudentClass>().HasData(
                new StudentClass { Id = 1, Method = 3, StudentClassId = "2f1e6d1d-7a0a-4b42-b4d1-25f0e7b4a4f1", Result = 10, StudentId = "815dd6f4-2d41-4c6c-a032-5e78a1cf065b", ClassId = "04b2851a-5d19-4aa2-aa14-f8d68d0c90b9", AttendingStatus = 3, FinalScore = 55, Gpalevel = 3 },
               new StudentClass { Id = 2, Method = 1, StudentClassId = "d32f4d16-78d6-4fe1-89d2-9653c8b12c6d", Result = 92, StudentId = "35f2f906-2a79-442e-b7d8-2f3f59c7c89c", ClassId = "e4e338a8-4413-4fb6-8652-990e20c40526", AttendingStatus = 3,  FinalScore = 35, Gpalevel = 3 },
               new StudentClass { Id = 3, Method = 2, StudentClassId = "9ae7ec99-1ee5-4a61-b2ff-308b14f2bb38", Result = 80, StudentId = "815dd6f4-2d41-4c6c-a032-5e78a1cf065b", ClassId = "04b2851a-5d19-4aa2-aa14-f8d68d0c90b9", AttendingStatus = 2, FinalScore = 78, Gpalevel = 1 },
               new StudentClass { Id = 4, Method = 2, StudentClassId = "c7e1f7c5-615e-4328-8e4f-77a70c57fd52", Result = 23, StudentId = "7a3e4b3c-5201-45fc-bb7d-18ab7e26cc50", ClassId = "6bfb28e9-10c2-4a02-9755-c1fcb9a01d14", AttendingStatus = 1, FinalScore = 85, Gpalevel = 2 },
               new StudentClass { Id = 5, Method = 1, StudentClassId = "b23a6a23-b8eb-4ec6-bd34-c3e11b446441", Result = 5, StudentId = "f3f59356-625e-47e7-9b9e-d2a8e6f2c6c6", ClassId = "6bfb28e9-10c2-4a02-9755-c1fcb9a01d14", AttendingStatus = 3, FinalScore = 92, Gpalevel = 3 },
               new StudentClass { Id = 6, Method = 2, StudentClassId = "5a9e7fd7-d49e-4c5b-946b-dac02ac8565d", Result = 18, StudentId = "cd9fe541-1c6f-4e9e-a94b-1ff748186975", ClassId = "176d899b-1c24-49fc-baf1-8755ef89f1b3", AttendingStatus = 2, FinalScore = 70, Gpalevel = 1 },
               new StudentClass { Id = 7, Method = 3, StudentClassId = "87acbe6a-7bcb-4c59-ba27-7f62421709f9", Result = 63, StudentId = "7a3e4b3c-5201-45fc-bb7d-18ab7e26cc50", ClassId = "176d899b-1c24-49fc-baf1-8755ef89f1b3", AttendingStatus = 1, FinalScore = 63, Gpalevel = 2 }
                );
